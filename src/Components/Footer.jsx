      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://sameerfaridi.in/" className="flex items-center">
            ...
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-[1rem]">
                  <a href="mailto:contact@kurmato.com" className="text-white">contact@kurmato.com</a>
                </li>
                <li>
                  <a href="mailto:info@kurmato.com" className="text-white">info@kurmato.com</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="https://www.facebook.com/profile.php?id=61552806154146"
            ...
            <a
              href="https://twitter.com/kurmato"
